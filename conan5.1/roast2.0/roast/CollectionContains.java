...
* <b>Overview</b>
* <dl>
* Comparison and printing functions for elements in collections.
* </dl>
* <p>
...
* </dl>
*/
public class CollectionContains extends CollectionType {
/**
...
{ return expVal.contains(new Integer(actVal)); } 
...
{ return expVal.contains(new Character(actVal)); }
/**
...
{ return expVal.contains(new Float(actVal)); } 
/**
...
{ return expVal.contains(new Byte(actVal)); } 
/**
...
{ return expVal.contains(new Boolean(actVal)); }
/**
...
{ return expVal.contains(new Double(actVal)); }
/**
...
{ return expVal.contains(new Short(actVal)); } 
/**
...
{ return expVal.contains(new Long(actVal)); } 
/**
